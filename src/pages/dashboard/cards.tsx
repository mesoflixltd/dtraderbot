        ...
        },
        {
            ...
            icon: (
                <svg width='48' height='48' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    />
                    <path
                        d='M14 24H20M28 24H34M24 14V20M24 28V34'
                        stroke='#377cfc'
                        strokeWidth='2.5'
                        strokeLinecap='round'
                    />
                    ...
                    <path
                        d='M12 12L16 16M32 32L36 36M36 12L32 16M16 32L12 36'
                        stroke='#377cfc'
                        strokeWidth='2'
                        strokeLinecap='round'
                    />
        ...
        },
        {
            ...
            icon: (
                <svg width='48' height='48' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <path
                        d='M24 6V10M42 24H38M24 42V38M6 24H10'
                        stroke='#ff444f'
                        strokeWidth='3'
                        strokeLinecap='round'
                    />
                    <path
                        d='M36.7 11.3L33.9 14.1M36.7 36.7L33.9 33.9M11.3 36.7L14.1 33.9M11.3 11.3L14.1 14.1'
                        stroke='#ff444f'
                        strokeWidth='2'
                        strokeOpacity='0.5'
                    />
