    ...
    return (
        <div className="campaigns-page">
            ...
            <nav className="campaigns-nav">
                ...
                <button 
                    className={classNames('campaigns-nav__btn', { 'campaigns-nav__btn--active': active_sub_tab === 'booking' })}
                ...
                {active_sub_tab === 'promotions' ? (
                    ...
                    >
                        {promotions.map((promo) => (
                            <div key={promo.id} className="promo-card" onClick={() => window.location.hash = promo.link}>
                                <div 
                        ...
                        <form className="booking-form" onSubmit={handleBookingSubmit}>
                            ...
                            <label className="booking-form__checkbox">
                                <input 
                                    ...
                                    required
                                />
                                <span>{localize('I confirm that I have a minimum of $100 and I am ready for a live trading session.')}</span>
                            </label>
